 ...
 */
return array (
  '"{path}" is not a valid directory.' => '{path} düzgün deyil.',
  '&lt; Previous' => '&lt; İrəli',
  '&lt;&lt; First' => '&lt;&lt; İlk',
  'Active Record requires a "db" CDbConnection application component.' => 'Active Record üçün "db" CDbConnection tətbiq komponenti lazımlıdır.',
  ...
  'Application Log' => 'Proqram loqu',
  'Application base path "{path}" is not a valid directory.' => 'Proqram yolu (base path) "{path}" düzgün deyil.',
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 'Tətbiq runtime yolu "{path}" düzgün deyil. Web server əməliyyatı tərəfindən yazma icazəsi olduğuna əmin olun.',
  ...
  'CDbCommand failed to execute the SQL statement: {error}' => 'CDbCommand bir SQL sorğusunu icra edə bilmədi: {error}',
  'CDbCommand failed to prepare the SQL statement: {error}' => 'CDbCommand bir SQL sorğusunu yarada bilmədi: {error}',
  'CDbConnection does not support reading schema for {driver} database.' => 'CDbConnection {driver} \'i üçün  oxuma dəstəyinə sahib deyil.',
  'CDbConnection failed to open the DB connection.' => 'CDbConnection DB əlaqəsini açarkən bir səhv meydana gəldi.',
  'CDbConnection failed to open the DB connection: {error}' => 'CDbConnection DB əlaqəsini açarkən bir səhv meydana gəldi: {error}',
  'CDbConnection is inactive and cannot perform any DB operations.' => 'CDbConnection hal-hazırda passiv vəziyyətdə və heç bir DB əməliyyatını reallaşdıra bilməz.',
  'CDbConnection.connectionString cannot be empty.' => 'CDbConnection.connectionString boş olmamalıdır.',
  ...
  'Event "{class}.{event}" is not defined.' => '"{class}.{event}" hadisə təyin olunmadı.',
  'Extension path "{path}" does not exist.' => '"{path}" adlı uzanti yoxdur.',
  'Failed to initialize the mcrypt module.' => 'mcrypt modulu başlanğıc üçün hazırlanarkən xəta yarandı.',
  'Failed to set unsafe attribute "{attribute}".' => 'Təhlükəsiz olmayan "{attribute}" təyin olunarkən xəta yarandı.',
  'Failed to write the uploaded file "{file}" to disk.' => 'Serverə yüklənən "{file}" faylı diskə yazılarkən xəta yarandı.',
  'File upload was stopped by extension.' => 'Fayl yükleme əməliyyatı fayl uzantısı xətası ilə dayandırıldı.',
  'Filter "{filter}" is invalid. Controller "{class}" does have the filter method "filter{filter}".' => '"{filter}" filtr düzgün deyil. Kontrolcü sınıf "{class}", "filter{filter}" isimli bir filtre methoduna sahip değil.',
  'Get a new code' => 'Kodu yenilə',
  'Go to page: ' => 'Səhifəyə get:',
  ...
  'Invalid operator "{operator}".' => '"{operator}", təyin olunamış bir operator.',
  'Last &gt;&gt;' => 'Son &gt;&gt;',
  'List data must be an array or an object implementing Traversable.' => 'List verilənləri, array və ya Traversable implement eden bir obyekt olmalıdır.',
  'List index "{index}" is out of bound.' => 'List indeksi "{index}", sərhədlərin xaricindədir.',
  'Login Required' => 'Üye Girişi Gerekli',
  'Map data must be an array or an object implementing Traversable.' => 'Map veriləni, array və ya Traversable implement eden bir obyekt olmalıdır.',
  'Missing the temporary folder to store the uploaded file "{file}".' => '"{file}" faylını yadda saxlamaq üçün lazımlı müvəqqəti fayl(tmp faylı) tapılmır.',
  'Next &gt;' => 'Sonraki &gt;',
  'No columns are being updated for table "{table}".' => '"{table}" cədvəlinə aid heç bir sütun yenilənə bilmədi.',
  'No counter columns are being updated for table "{table}".' => '"{table}" cedveli üçün sayğac sütunları yenilənə bilmədi.',
  ...
  'Please fix the following input errors:' => 'Xahiş edirik  səhvləri düzəldin:',
  'Property "{class}.{property}" is not defined.' => '"{class}.{property}" xüsusiyyəti təyin olunmamışdır.',
  'Property "{class}.{property}" is read only.' => '"{class}.{property}" xüsusiyyəti read only vəziyyətindədir.',
  ...
  'Resetting PK sequence is not supported.' => 'PK ardıcıllığı sıfırlama dəstəklənmir.',
  ...
  'Table "{table}" does not exist.' => '"{table}" adında bir cədvəl yoxdur.',
  'Table "{table}" does not have a column named "{column}".' => '"{table}" cədvəlində "{column}" sütunu yoxdur.',
  ...
  'The CSRF token could not be verified.' => 'CSRF token təsdiqlənmədi.',
  ...
  'The file "{file}" cannot be uploaded. Only files with these extensions are allowed: {extensions}.' => 'Fayl yüklənmədi. İcazə verilən uzantılar : {extensions}',
  'The file "{file}" is too large. Its size cannot exceed {limit} bytes.' => '"{file}" fayl çok büyükdür. Həcmi {limit} byte-dan büyük olmamalıdır.',
  'The file "{file}" is too small. Its size cannot be smaller than {limit} bytes.' => '"{file}" fayl çox kiçikdir. Həcmi {limit} byte-dan  kiçik  olmamalıdır.',
  'The file "{file}" was only partially uploaded.' => '"{file}" faylı qismən  yükləndi.',
  ...
  'The item "{name}" does not exist.' => '"{name}" elementi tapılmadı.',
  'The item "{parent}" already has a child "{child}".' => '"{parent}" öğesi zaten "{child}" çocuğuna sahip.',
  'The layout path "{path}" is not a valid directory.' => 'Layout yolu "{path}" düzgün deyil.',
  'The list is read only.' => 'Siyahı yalnız oxuna bilər.',
  'The map is read only.' => 'Xəritə yalnız oxuna bilər.',
  'The module path "{path}" is not a valid directory.' => 'Modul yolu "{path}" düzgün deyil.',
  'The pattern for 12 hour format must be "h" or "hh".' => '12 saat formatı üçün model "h" və ya "hh" şeklindedir.',
  'The pattern for 24 hour format must be "H" or "HH".' => '24 saat formatı üçün model "H" və ya "HH" şeklindedir.',
  'The pattern for AM/PM marker must be "a".' => 'AM/PM belirleyicisi için model "a" şeklindedir.',
  'The pattern for day in month must be "F".' => 'Ayın günleri üçün model "F" şeklindedir.',
  ...
  'Your request is invalid.' => 'Sorğunuz yalnış.',
  'Your request is not valid.' => 'Sorğunuz düzgün deyil.',
  '{attribute} "{value}" has already been taken.' => '{attribute} "{value}" artıq qəbul edilmişdir.',
  '{attribute} "{value}" is invalid.' => '{attribute} "{value}" geçersiz.',
  '{attribute} cannot accept more than {limit} files.' => '{attribute}, {limit} fayldan artıq qəbul edə bilməz.',
  '{attribute} cannot be blank.' => '{attribute} boş olmamalıdır.',
  '{attribute} is invalid.' => '{attribute} yalnışdır.',
  '{attribute} is not a valid URL.' => '{attribute} düzgün bir URL deyil.',
  '{attribute} is not a valid email address.' => '{attribute} düzgün  mail addresi deyil.',
  '{attribute} is not in the list.' => '{attribute} siyahıda deyil.',
  '{attribute} is of the wrong length (should be {length} characters).' => '{attribute} səhv simvol sayındadır ({length} simvol olmalıdır).',
  '{attribute} is too big (maximum is {max}).' => '{attribute} çox büyükdür ən çox {max} olmalıdır).',
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} çox uzundur (ən çox {max} simvol ola bilər).',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute} çox qisadır (ən azı {min} simvol ola bilər).',
  '{attribute} is too small (minimum is {min}).' => '{attribute} çox kiçikdir (ən azı {min} olmalıdır).',
  ...
  '{attribute} must be {type}.' => '{attribute}, {type} tipinde olmalıdır.',
  '{attribute} must be {value}.' => '{attribute} dəyəri {value} olmalıdır.',
  '{attribute} must not be equal to "{compareValue}".' => '{attribute}, "{compareValue}" dəyərinə bərabər olmamalıdır.',
  '{className} does not support add() functionality.' => '{className}, add() funksiyası dəstəklənmir.',
  '{className} does not support delete() functionality.' => '{className}, delete() funksiyası dəstəklənmir.',
  '{className} does not support flush() functionality.' => '{className}, flush() funksiyası dəstəklənmir.',
  '{className} does not support get() functionality.' => '{className}, get() funksiyası dəstəklənmir.',
  '{className} does not support set() functionality.' => '{className}, set() funksiyası dəstəklənmir.',
  '{class} does not have a method named "{name}".' => '{class}, "{name}" adında bir metoda sahib deyil.',
  '{class} does not have relation "{name}".' => '{class}, "{name}" ilə əlaqəsi yoxdur.',
  '{class} does not support fetching all table names.' => '{class}, bütün cədvəl adlarını çəkməyi dəstəkləmir.',
  ...
  '{controller} cannot find the requested view "{view}".' => '{controller}, qeyd olunan "{view}" görüntüsü tapılmadı.',
  ...
  '{widget} cannot find the view "{view}".' => '{widget}, "{view}" görüntüsü tapılmadı.',
);
